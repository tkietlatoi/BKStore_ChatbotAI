              ...
              <div>
                ...
                <div className="flex gap-3 items-center">
                  <input
                    ...
                    className="flex-1 text-xs bg-slate-50 border border-slate-200 rounded-xl px-3 py-2 outline-none focus:bg-white focus:border-blue-500 transition-all"
                  />
                  <div className="w-10 h-10 rounded-xl bg-slate-100 border border-slate-200 p-1 shrink-0 flex items-center justify-center overflow-hidden">
                    {formThumbnail ? (
                      <img
                        src={formThumbnail}
                        alt="Preview"
